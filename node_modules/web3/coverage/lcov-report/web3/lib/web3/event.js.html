...
<html lang="en">
<head>
    <title>Code coverage report for web3/lib/web3/event.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">web3/lib/web3/event.js</span></h1>
    <h2>
        Statements: <span class="metric">91.51% <small>(97 / 106)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">83.33% <small>(35 / 42)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">90.91% <small>(20 / 22)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">91.43% <small>(96 / 105)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">web3/lib/web3/</a> &#187; event.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >            console.warn('Can\'t find event for log');</span>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (utils.isFunction(arguments[arguments.length - 1])) {
...
&nbsp;
    ...
    var subscription = new Subscription({
        ...
        subscribeMethod: 'ctxc_subscribe',
        unsubscribeMethod: 'ctxc_unsubscribe',
 ...
 * @param {Contract}
 */
ContractEvent.prototype.getPastEvents = <span class="fstat-no" title="function not covered" >function(options, callback){</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var args = this.getArgs.apply(this, arguments);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (utils.isFunction(callback)) {</span>
<span class="cstat-no" title="statement not covered" >        this._requestManager.sendAsync({</span>
            method: 'ctxc_getLogs',
            params: [args.options]
        }, <span class="fstat-no" title="function not covered" >function(error, logs){</span>
<span class="cstat-no" title="statement not covered" >            if(!error) {</span>
<span class="cstat-no" title="statement not covered" >                args.callback(null, logs.map(args.formatter));</span>
            } else {
<span class="cstat-no" title="statement not covered" >                args.callback(error);</span>
            }
        });
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this._requestManager.send({</span>
        method: 'ctxc_getLogs',
        params: [args.options]
    }).map(args.formatter);
};
